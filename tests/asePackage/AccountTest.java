...
public class AccountTest {
	...
	public void setUp() throws Exception {
		...
		account2.addOwner(new Customer("Ioan", "Eu", 1));
		account3=new Account(2, new Customer("Ioan", "Eu", 1));
		account3.depositMoney(100);
		customerTest4.add(new Customer("Ioan", "Eu", 1));
		customerTest4.add(new Customer("Ioana", "Tu", 2));
	...
	public void testHashCode() {
		...
		assertTrue("Wrong hash code (Is: "+currentValue+"; Should be "+result+")",currentValue.equals(result));
	}
	...
	public void testGetOwnerList() {
		...
		result.add(new Customer("Ioan", "Eu", 1));
		result.add(new Customer("Ioana", "Tu", 2));

		assertTrue("Wrong owner list (Is: "+currentValue+"; Should be "+result+")",currentValue.containsAll(result));
	}
	...
	public void testGetBalance() {
		...
		assertTrue("Wrong balance (Is: "+currentValue+"; Should be "+result+")",currentValue.equals(result));
	}
	...
	public void testAddOwner() {
		...
		account2.addOwner(new Customer("Ioana", "Tu", 2));
		ArrayList<Customer> currentValue=account2.getOwnerList();
		assertTrue("Wrong owner list (Is: "+currentValue+"; Should be "+result+")",currentValue.equals(result));
	}
	...
	public void testRemoveOwner() {
		...
		account2.removeOwner(new Customer("Ioana", "Tu", 2));
		ArrayList<Customer> currentValue=account2.getOwnerList();
		assertTrue("Wrong owner list (Is: "+currentValue+"; Should be "+result+")",currentValue.equals(result));
	}
	...
	public void testEquals1() {
		...
		assertTrue("Wrong equal result (Is: "+result+"; Should be false)",result);
	}
	...
	public void testEquals3() {
		...
		assertTrue("Wrong equal result (Is: "+result+"; Should be true)",result);
	}
	...
	public void testEquals5() {
		Boolean result=account2.equals(new Account(1, new Customer("Ioanp", "Eu", 1)));
		assertTrue("Wrong equal result (Is: "+result+"; Should be true)",result);
	}
}
